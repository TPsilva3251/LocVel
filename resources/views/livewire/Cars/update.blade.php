            ...
            <div>                
                <div class="flex flex-row-reverse mx-28 mt-4 gap-4">
                    <button class="btn-green px-11 hover:bg-green-700 hover:font-bold"
                        wire:click.prevent="update({{$carid}})">Alterar</button>
                    <button class="btn-red px-8 hover:bg-red-700 hover:font-bold" wire:model.prevent="resetfields()">Cancealr</button>
                </div>
            </div>
        </form>
    </div>
